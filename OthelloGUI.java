...
// - create the main frame
   ...
   */
      ...
      //Declaring and creating new bufferedreader to read the "config.txt" file
         BufferedReader in = new BufferedReader(new FileReader("config.txt"));
      
      //Initilizing max game
         MAXGAME = Integer.parseInt(in.readLine());
      
      //Initilizing logoIcon 
         logoIcon = in.readLine();
      
      //Initilizing the array iconFile
         ...
         System.out.println ("Problem occured while reading the while");
